...
var cli struct {
	...
	Import             subcmd.ImportCmd             `cmd:"" help:"Import a file or directory."`
	...
	Wip                subcmd.WipCmd                `cmd:"" help:"Make posts WIP."`
...
func main() {
	...
	err = ctx.Run(&kasa.Context{
		Team:   cli.Team,
		Driver: esa.NewDriver(cli.Team, cli.Token, cli.Debug, version),
